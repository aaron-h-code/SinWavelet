...
class Config(object):
    ...
    def parse(self):
        ...
        self._add_wavelet_config(parser_train)
    ...
    def _add_network_config(self, parser):
        ...
        group.add_argument('--aug_type', type=str, default='cropping', help='cropping, rotation, flipping')
        group.add_argument('--n_augs', type=int, default=4, help='number of transformations')

        group.add_argument('--margin', type=float, default=0, help='margin in potential')
    ...
    def _add_training_config(self, parser):
        ...
        group.add_argument('--alpha',type=float, default=100, help='reconstruction loss weight')
        ...
        group.add_argument('--batch_size', type=int, default=1, help='generate different samples during training')
    ...
    def _add_wavelet_config(self, parser):
        '''arguments for wavelet'''
        group = parser.add_argument_group('wavelet')
        group.add_argument('--wavelet_type', type=str, default='haar', help='wavelet type')
        group.add_argument('--padding_mode', type=str, default='zero', help='padding mode for wavelet reconstruction')
        group.add_argument('--min_res', type=int, default=4, help='minimum resolution for the shortest dim after wavelet decomposition')