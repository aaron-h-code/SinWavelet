...
class DWTForward(nn.Module):
    ...
    Args:
        ...
        mode (str): 'zero', 'symmetric', 'reflect' or 'periodization'. The
            padding scheme
        """
    def __init__(self, J=1, wave='db1', mode='zero', device='cpu'):
        super().__init__()
        ...
        # Prepare the filters
        filts = lowlevel.prep_filt_afb3d(h0_col, h1_col, h0_row, h1_row, h0_dep, h1_dep, device)
    ...
    def forward(self, x):
        ...
        for j in range(self.J):
            ...
            ll, high = lowlevel.AFB3D.apply(
                ll, self.h0_col, self.h1_col, self.h0_row, self.h1_row, self.h0_dep, self.h1_dep, mode)
            yh.append(high)
...
class DWTInverse(nn.Module):
    ...
    def __init__(self, wave='db1', mode='zero', device='cpu'):
        ...
        # Prepare the filters
        filts = lowlevel.prep_filt_sfb3d(g0_col, g1_col, g0_row, g1_row, g0_dep, g1_dep, device)
    ...
    def forward(self, coeffs):
        ...
        Args:
            coeffs (yl, yh): tuple of lowpass and bandpass coefficients, where:
              ...
              :math:`list(N, C_{in}, 7, H_{in}'', W_{in}'')`. I.e. should match
        ...
        for h in yh[::-1]:
            if h is None:
                h = torch.zeros(ll.shape[0], ll.shape[1], 7, ll.shape[-2],
            ...
            ll = lowlevel.SFB3D.apply(
                ll, h, self.g0_col, self.g1_col, self.g0_row, self.g1_row, self.g0_dep, self.g1_dep, mode)
